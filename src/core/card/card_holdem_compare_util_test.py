...
class CardHoldemCompareUtilTest(unittest.TestCase):
    ...
    def test__compare_straight(self):
        ...
        self.assertEqual(-1, card_holdem_compare_util._compare_straight(cards_1, cards_2))
        color_1 = [0, 1, 2, 3, 0]
        point_1 = [5, 6, 7, 8, 9]
        cards_1 = _create_cards(color_1, point_1)
        color_2 = [0, 1, 2, 3, 0]
        point_2 = [5, 6, 7, 8, 9]
        cards_2 = _create_cards(color_2, point_2)
        self.assertEqual(0, card_holdem_compare_util._compare_straight(cards_1, cards_2))
        color_1 = [0, 1, 2, 3, 0]
        point_1 = [6, 7, 8, 9, 10]
        cards_1 = _create_cards(color_1, point_1)
        color_2 = [0, 1, 2, 3, 0]
        ...
        cards_1, cards_2 = cards_2, cards_1
        self.assertEqual(1, card_holdem_compare_util._compare_straight(cards_1, cards_2))
        self.assertEqual(0, card_holdem_compare_util._compare_straight(cards_1, cards_1))
        self.assertEqual(0, card_holdem_compare_util._compare_straight(cards_2, cards_2))
    ...
    def test_compare_four_of_a_kind(self):
        ...
        self.assertEqual(-1, card_holdem_compare_util.compare_2_group_in_same_type(
            cards_1, cards_2, CardType.FOUR_OF_A_KIND))
        self.assertEqual(-1, card_holdem_compare_util.compare_2_group_in_same_type(
            cards_1, cards_3, CardType.FOUR_OF_A_KIND))
        self.assertEqual(1, card_holdem_compare_util.compare_2_group_in_same_type(
            cards_2, cards_3, CardType.FOUR_OF_A_KIND))
        self.assertEqual(0, card_holdem_compare_util.compare_2_group_in_same_type(
