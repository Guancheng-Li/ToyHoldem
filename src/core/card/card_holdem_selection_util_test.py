...
def _check_expected_cards(
    cards: List[Card], expected_cards: List[Card]) -> bool:
    ...
    for item in expected_cards:
        if item.unique_id() not in card_unique_ids:
            return False, \
                f'Expected card {item.encode()} is \
                    not in selected cards({_encode_cards(cards)}).'
    return True, None
...
class CardHoldemCompareUtilTest(unittest.TestCase):
    ...
    def test_select_cards(self):
        ...
        selected_cards_0 = card_holdem_selection_util.select_high_score_cards(
            cards_0)
        expected_cards_0 = cards_0[0:5]
        res, error_msg = _check_expected_cards(
            selected_cards_0, expected_cards_0)
        ...
        selected_cards_1 = card_holdem_selection_util.select_high_score_cards(
            cards_1)
        expected_cards_1 = cards_1[0:5]
        res, error_msg = _check_expected_cards(
            selected_cards_1, expected_cards_1)
        self.assertTrue(res, msg=error_msg)
        ...
        selected_cards_2 = card_holdem_selection_util.select_high_score_cards(
            cards_2)
        expected_cards_2 = cards_2[1:5]
        res, error_msg = _check_expected_cards(
            selected_cards_2, expected_cards_2)
        self.assertTrue(res, msg=error_msg)
        ...
        selected_cards_3 = card_holdem_selection_util.select_high_score_cards(
            cards_3)
        expected_cards_3 = cards_3[0:5]
        res, error_msg = _check_expected_cards(
            selected_cards_3, expected_cards_3)
        self.assertTrue(res, msg=error_msg)
        ...
        selected_cards_4 = card_holdem_selection_util.select_high_score_cards(
            cards_4)
        expected_cards_4 = cards_4[0:5]
        res, error_msg = _check_expected_cards(
            selected_cards_4, expected_cards_4)
        self.assertTrue(res, msg=error_msg)
        ...
        selected_cards_5 = card_holdem_selection_util.select_high_score_cards(
            cards_5)
        expected_cards_5 = cards_5[0:5]
        res, error_msg = _check_expected_cards(
            selected_cards_5, expected_cards_5)
        self.assertTrue(res, msg=error_msg)
        ...
        selected_cards_6 = card_holdem_selection_util.select_high_score_cards(
            cards_6)
        expected_cards_6 = cards_6[0:5]
        res, error_msg = _check_expected_cards(
            selected_cards_6, expected_cards_6)
        self.assertTrue(res, msg=error_msg)
        ...
        selected_cards_7 = card_holdem_selection_util.select_high_score_cards(
            cards_7)
        expected_cards_7 = cards_7[0:4]
        res, error_msg = _check_expected_cards(
            selected_cards_7, expected_cards_7)
        self.assertTrue(res, msg=error_msg)
        ...
        selected_cards_8 = card_holdem_selection_util.select_high_score_cards(
            cards_8)
        expected_cards_8 = cards_8[0:5]
        res, error_msg = _check_expected_cards(
            selected_cards_8, expected_cards_8)
        self.assertTrue(res, msg=error_msg)
        ...
        selected_cards_9 = card_holdem_selection_util.select_high_score_cards(
            cards_9)
        expected_cards_9 = cards_9[0:5]
        res, error_msg = _check_expected_cards(
            selected_cards_9, expected_cards_9)
        self.assertTrue(res, msg=error_msg)
        ...
        selected_cards_10 = card_holdem_selection_util.select_high_score_cards(
            cards_10)
        expected_cards_10 = cards_10[0:5]
        res, error_msg = _check_expected_cards(
            selected_cards_10, expected_cards_10)
        self.assertTrue(res, msg=error_msg)
        ...
        selected_cards_11 = card_holdem_selection_util.select_high_score_cards(
            cards_11)
        expected_cards_11 = cards_11[0:3]
        res, error_msg = _check_expected_cards(
            selected_cards_11, expected_cards_11)
        self.assertTrue(res, msg=error_msg)
        ...
        selected_cards_12 = card_holdem_selection_util.select_high_score_cards(
            cards_12)
        expected_cards_12 = cards_12[0:5]
        res, error_msg = _check_expected_cards(
            selected_cards_12, expected_cards_12)
        self.assertTrue(res, msg=error_msg)
